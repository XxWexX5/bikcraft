...
$email_envio = 'portfoliobikcraft@portfoliobikcraft.epizy.com'; // E-mail receptor
$email_pass = 'portfoliobikcraft'; // Senha do e-mail

$site_name = 'Bikcraft'; // Nome do Site
$site_url = 'http://youngbikcraft.epizy.com/'; // URL do Site
